...
> <a href="https://apiguard.co"><img src="https://apiguard.co/favicon.svg" height="24" align="center" /></a> &nbsp; **[APIGuard](https://apiguard.co)**
>
> Automatically test your API against its OpenAPI spec on every deploy. Catch breaking changes, schema drift, and contract violations before they reach production. **[Try it free →](https://apiguard.co/register)**
...
- [Enabling two factor authentication](#8-enabling-two-factor-authentication-phased-out)
